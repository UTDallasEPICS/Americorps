...
import require$$2 from 'https://www.gstatic.com/firebasejs/9.1.3/firebase-app.js';
...
enum_maps81db3ff6.AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
enum_maps81db3ff6.ActionCodeOperation = ActionCodeOperation$1;
enum_maps81db3ff6.ActionCodeURL = ActionCodeURL$1;
enum_maps81db3ff6.AuthCredential = AuthCredential$1;
enum_maps81db3ff6.AuthImpl = AuthImpl;
enum_maps81db3ff6.BaseOAuthProvider = BaseOAuthProvider;
enum_maps81db3ff6.Delay = Delay;
enum_maps81db3ff6.EmailAuthCredential = EmailAuthCredential$1;
enum_maps81db3ff6.EmailAuthProvider = EmailAuthProvider$1;
enum_maps81db3ff6.FacebookAuthProvider = FacebookAuthProvider$1;
enum_maps81db3ff6.FactorId = FactorId$1;
enum_maps81db3ff6.FederatedAuthProvider = FederatedAuthProvider;
enum_maps81db3ff6.FetchProvider = FetchProvider;
enum_maps81db3ff6.GithubAuthProvider = GithubAuthProvider$1;
enum_maps81db3ff6.GoogleAuthProvider = GoogleAuthProvider$1;
enum_maps81db3ff6.OAuthCredential = OAuthCredential$1;
enum_maps81db3ff6.OAuthProvider = OAuthProvider$1;
enum_maps81db3ff6.OperationType = OperationType$1;
enum_maps81db3ff6.PhoneAuthCredential = PhoneAuthCredential$1;
enum_maps81db3ff6.ProviderId = ProviderId$1;
enum_maps81db3ff6.SAMLAuthCredential = SAMLAuthCredential;
enum_maps81db3ff6.SAMLAuthProvider = SAMLAuthProvider$1;
enum_maps81db3ff6.STORAGE_AVAILABLE_KEY = STORAGE_AVAILABLE_KEY;
enum_maps81db3ff6.SignInMethod = SignInMethod$1;
enum_maps81db3ff6.TwitterAuthProvider = TwitterAuthProvider$1;
enum_maps81db3ff6.UserImpl = UserImpl;
enum_maps81db3ff6._addTidIfNecessary = _addTidIfNecessary;
enum_maps81db3ff6._assert = _assert;
enum_maps81db3ff6._assertInstanceOf = _assertInstanceOf;
enum_maps81db3ff6._assertLinkedStatus = _assertLinkedStatus;
enum_maps81db3ff6._castAuth = _castAuth;
enum_maps81db3ff6._createError = _createError;
enum_maps81db3ff6._emulatorUrl = _emulatorUrl;
enum_maps81db3ff6._fail = _fail;
enum_maps81db3ff6._getClientVersion = _getClientVersion;
enum_maps81db3ff6._getCurrentUrl = _getCurrentUrl;
enum_maps81db3ff6._getInstance = _getInstance;
enum_maps81db3ff6._isAndroid = _isAndroid;
enum_maps81db3ff6._isChromeIOS = _isChromeIOS;
enum_maps81db3ff6._isFirefox = _isFirefox;
enum_maps81db3ff6._isHttpOrHttps = _isHttpOrHttps;
enum_maps81db3ff6._isIE10 = _isIE10;
enum_maps81db3ff6._isIOS = _isIOS;
enum_maps81db3ff6._isIOS7Or8 = _isIOS7Or8;
enum_maps81db3ff6._isIOSStandalone = _isIOSStandalone;
enum_maps81db3ff6._isIframe = _isIframe;
enum_maps81db3ff6._isMobileBrowser = _isMobileBrowser;
enum_maps81db3ff6._isSafari = _isSafari;
enum_maps81db3ff6._link = _link;
enum_maps81db3ff6._performApiRequest = _performApiRequest;
enum_maps81db3ff6._persistenceKeyName = _persistenceKeyName;
enum_maps81db3ff6._reauthenticate = _reauthenticate;
enum_maps81db3ff6._signInWithCredential = _signInWithCredential;
enum_maps81db3ff6.applyActionCode = applyActionCode$2;
enum_maps81db3ff6.checkActionCode = checkActionCode$1;
enum_maps81db3ff6.confirmPasswordReset = confirmPasswordReset$1;
enum_maps81db3ff6.connectAuthEmulator = connectAuthEmulator$1;
enum_maps81db3ff6.createUserWithEmailAndPassword = createUserWithEmailAndPassword$1;
enum_maps81db3ff6.debugAssert = debugAssert;
enum_maps81db3ff6.debugErrorMap = debugErrorMap$1;
enum_maps81db3ff6.debugFail = debugFail;
enum_maps81db3ff6.deleteUser = deleteUser$1;
enum_maps81db3ff6.fetchSignInMethodsForEmail = fetchSignInMethodsForEmail$1;
enum_maps81db3ff6.finalizeEnrollPhoneMfa = finalizeEnrollPhoneMfa;
enum_maps81db3ff6.getAdditionalUserInfo = getAdditionalUserInfo$1;
enum_maps81db3ff6.getIdToken = getIdToken$1;
enum_maps81db3ff6.getIdTokenResult = getIdTokenResult$1;
enum_maps81db3ff6.getMultiFactorResolver = getMultiFactorResolver$1;
enum_maps81db3ff6.inMemoryPersistence = inMemoryPersistence$1;
enum_maps81db3ff6.initializeAuth = initializeAuth$1;
enum_maps81db3ff6.isSignInWithEmailLink = isSignInWithEmailLink$1;
enum_maps81db3ff6.linkWithCredential = linkWithCredential$1;
enum_maps81db3ff6.multiFactor = multiFactor$1;
enum_maps81db3ff6.onAuthStateChanged = onAuthStateChanged$1;
enum_maps81db3ff6.onIdTokenChanged = onIdTokenChanged$1;
enum_maps81db3ff6.parseActionCodeURL = parseActionCodeURL$1;
enum_maps81db3ff6.prodErrorMap = prodErrorMap$1;
enum_maps81db3ff6.reauthenticateWithCredential = reauthenticateWithCredential$1;
enum_maps81db3ff6.registerAuth = registerAuth;
enum_maps81db3ff6.reload = reload$1;
enum_maps81db3ff6.sendEmailVerification = sendEmailVerification$2;
enum_maps81db3ff6.sendPasswordResetEmail = sendPasswordResetEmail$2;
enum_maps81db3ff6.sendPhoneVerificationCode = sendPhoneVerificationCode;
enum_maps81db3ff6.sendSignInLinkToEmail = sendSignInLinkToEmail$2;
enum_maps81db3ff6.setPersistence = setPersistence$1;
enum_maps81db3ff6.signInAnonymously = signInAnonymously$1;
enum_maps81db3ff6.signInWithCredential = signInWithCredential$1;
enum_maps81db3ff6.signInWithCustomToken = signInWithCustomToken$2;
enum_maps81db3ff6.signInWithEmailAndPassword = signInWithEmailAndPassword$1;
enum_maps81db3ff6.signInWithEmailLink = signInWithEmailLink$2;
enum_maps81db3ff6.signInWithIdp = signInWithIdp;
enum_maps81db3ff6.signOut = signOut$1;
enum_maps81db3ff6.startEnrollPhoneMfa = startEnrollPhoneMfa;
enum_maps81db3ff6.unlink = unlink$1;
enum_maps81db3ff6.updateCurrentUser = updateCurrentUser$1;
enum_maps81db3ff6.updateEmail = updateEmail$1;
enum_maps81db3ff6.updatePassword = updatePassword$1;
enum_maps81db3ff6.updateProfile = updateProfile$2;
enum_maps81db3ff6.useDeviceLanguage = useDeviceLanguage$1;
enum_maps81db3ff6.verifyBeforeUpdateEmail = verifyBeforeUpdateEmail$1;
enum_maps81db3ff6.verifyPasswordResetCode = verifyPasswordResetCode$1;

Object.defineProperty(rn, '__esModule', { value: true });

var reactNative = require$$0;
var app = require$$2;
var enum_maps = enum_maps81db3ff6;
